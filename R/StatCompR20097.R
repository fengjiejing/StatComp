#' @title gammaCI 
#' @description Find confidence intervals of gamma function by dichotomy
#' @param alpha the confidence coefficient
#' @param lambda the shape parameter of the gamma function
#' @param beta the scale parameter of the gamma function
#' @return confidence interval of gamma function
...
#' @param lambda the shape parameter of t he gamma function
#' @param beta the scale parameter of the gamma function
#' @param prec The difference between the true value and the estimated value
